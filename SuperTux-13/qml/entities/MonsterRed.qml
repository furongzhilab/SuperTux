...
Monster {
    id: monsterRed
    variationType: "monsterRed"

    property alias sprite: redSprite
    ...
    TexturePackerAnimatedSprite {
        id: redSprite
        source: "../../assets/bouncing_snowball/sprite/red_bounceball.json"
    ...
    BoxCollider {
        ...
        anchors.top: redSprite.bottom
        anchors.left: redSprite.left
    ...
    function die() {
        alive = false
        image.source = "../../assets/bouncing_snowball/sprite/mrs-squished-left.png"
        hideTimer.start()
