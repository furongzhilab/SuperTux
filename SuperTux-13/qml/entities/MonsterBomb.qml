...
Monster {
    id: monsterBomb
    variationType: "monsterBomb"

    property alias sprite: bombSprite
    ...
    property alias dieBomb: dieSprite

    // set image
    TexturePackerAnimatedSprite {
        id: bombSprite
        source: "../../assets/bomb_opponent/sprite/bomb.json"
    ...
    Image {
        ...
        TexturePackerAnimatedSprite {
            id: dieSprite
            source: "../../assets/explosion/sprite/explosion.json"
            frameNames: ["explosion-0.png", "explosion-1.png", "explosion-2.png", "explosion-3.png", "explosion-4.png", "explosion-5.png", "explosion-6.png", "explosion-7.png", "explosion-8.png", "explosion-9.png", "explosion-10.png"]
            interpolate: false
    ...
    BoxCollider {
        ...
        anchors.top: bombSprite.bottom
        anchors.left: bombSprite.left
    ...
    BoxCollider {
        ...
        height: 5
        anchors.top: bombSprite.bottom
        anchors.right: bombSprite.right
